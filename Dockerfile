...
RUN cd /godot/agones/sdks/cpp/.build && cmake .. -DCMAKE_BUILD_TYPE=Release -DCMAKE_POSITION_INDEPENDENT_CODE=ON -G "Unix Makefiles" -Wno-dev -DCMAKE_INSTALL_PREFIX=.install -DBUILD_SHARED_LIBS=ON
